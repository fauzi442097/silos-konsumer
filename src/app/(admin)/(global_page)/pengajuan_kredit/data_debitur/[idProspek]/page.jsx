...
const usePostSimpanDataDebitur = (mySwal, hitUpdateBiaya, router) => {
    return usePost(['inquiry-by-tanggallahir'], '/v2/nasabah/complete', [], {
        ...
        onSuccess: (data, variables, context) => {
            ...
            let idProspect = variables.nasabah.idProspect;
            ...
            router.push(`/pengajuan_kredit/ceklis_dokumen/${idProspect}`)
        }
    })
}
...
const DataDebitur = ({ params }) => {
    ...
    const onSubmit = async (formData) => {
        ...
        let nasabah = {
            ...
            idPekerjaanPasangan: formData.status_debitur.value === 1 ? formData.jenis_pekerjaan_pasangan : null,
            tglLahirPasangan: formData.status_debitur.value === 1 ? formData.tanggal_lahir_pasangan : null,
            cif: formData.cif,
