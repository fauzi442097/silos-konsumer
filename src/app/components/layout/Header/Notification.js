...
const Notification = ({ setShowDropdownTopbar, btnRef, className, ...props }) => {
  ...
  return (
    <>
        ...
        className={`w-80 absolute rounded-2xl dark:text-grey top-14 right-2 shadow-lg dark:topbar-box-shadow-dark flex flex-col z-50 ${className || ''} transition duration-300 ease-in-out`} {...props}>
